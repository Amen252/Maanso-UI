      ...
      >
        <div className="h-[72px] max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              to="/login"
              className="px-5 py-2 text-[#007ACC] hover:bg-[#007ACC]/10 rounded-md transition"
            >
              Gal Akawnka
            </Link>
            <Link
              to="/register"
              className="px-5 py-2 bg-[#007ACC] text-white rounded-md hover:bg-[#0062a3] transition"
            >
              Is-Diiwaan Geli
            </Link>
          </div>
      ...
      >
        <div className="px-4 py-6 space-y-2">
          ...
          <Link
            to="/login"
            onClick={() => setIsOpen(false)}
            className="block w-full text-center px-4 py-3 text-[#007ACC] hover:bg-[#007ACC]/10 rounded-md"
          >
            Gal Akawnka
          </Link>
          ...
          <Link
            to="/register"
            onClick={() => setIsOpen(false)}
            className="block w-full text-center px-4 py-3 bg-[#007ACC] text-white rounded-md hover:bg-[#0062a3]"
          >
            Is-Diiwaan Geli
          </Link>
        </div>
