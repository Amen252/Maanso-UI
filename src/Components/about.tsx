...
const About = () => {
  return (
    <section className="py-16 sm:py-20 md:py-28 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-center">
        ...
        >
          <div className="border border-[#4189DD]/15 p-3 sm:p-4 md:p-6 bg-white shadow-md">
            <img
              ...
              className="
                w-full
                max-h-[300px] sm:max-h-[380px] md:max-h-[520px] lg:max-h-[760px]
          ...
          {/* Caption */}
          <div className="mt-3 text-[11px] sm:text-sm text-slate-500 italic">
        ...
        >
          {/* Vertical identity line (hide on small phones) */}
          <div className="absolute -left-6 top-0 h-full w-[3px] bg-[#4189DD] hidden sm:block" />

          <span className="inline-flex items-center gap-2 mb-4 sm:mb-6 text-[11px] sm:text-sm text-[#4189DD] uppercase tracking-widest">
            <BookText className="w-4 h-4" />
            Ku Saabsan
          </span>

          <h2
            className="text-2xl sm:text-3xl md:text-5xl font-medium text-slate-900 mb-5 sm:mb-8 leading-snug sm:leading-tight"
            style={{ fontFamily: '"Playfair Display", serif' }}
          >
            Waa maxay <span className="text-[#4189DD]">Maanso</span>?
          </h2>

          <p className="text-slate-600 text-sm sm:text-base leading-relaxed mb-4 sm:mb-6 max-w-xl">
          ...
          {/* Actions */}
          <div className="mt-7 sm:mt-10 flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-6">
